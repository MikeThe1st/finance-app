  ...
  return (
    <div className="font-sans flex flex-col min-h-screen">
      ...
      <section className="services text-center py-10 bg-gray-100 rounded-md shadow-md">
        <h2 className="text-lg sm:text-2xl md:text-3xl mb-4 sm:mb-6 font-bold">Nasze usługi</h2>
        <ul className="space-y-6 p-4">
          ...
          <li className='flex flex-col justify-center items-center'>
            <h3 className="text-lg sm:text-2xl mb-2 font-semibold">Planowanie emerytalne</h3>
            <p className='max-w-screen-lg text-xl'>
          ...
          <li className='flex flex-col justify-center items-center'>
            <h3 className="text-lg sm:text-2xl mb-2 font-semibold">Kredyty i Pożyczki</h3>
            <p className='max-w-screen-lg text-xl'>
          ...
          <li className='flex flex-col justify-center items-center'>
            <h3 className="text-lg sm:text-2xl mb-2 font-semibold">Podatki i Rozliczenia</h3>
            <p className='max-w-screen-lg text-xl'>
          ...
          <li className='flex flex-col justify-center items-center'>
            <h3 className="text-lg sm:text-2xl mb-2 font-semibold">Analiza Portfela Inwestycyjnego</h3>
            <p className='max-w-screen-lg text-xl'>
